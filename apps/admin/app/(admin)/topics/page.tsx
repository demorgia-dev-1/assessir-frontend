  ...
  return (
    <section className="flex animate-in fade-in slide-in-from-bottom-4 duration-700 flex-col gap-6 lg:h-full lg:min-h-0">
      <header className="glass-panel rounded-[2rem] border border-white/80 px-8 py-5 shadow-soft shadow-slate-900/5">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-slate-950">{totalTopics}</p>
      ...
      {editModalOpen && topicToEdit && (
        <div className="fixed inset-0 z-50 flex animate-in items-center justify-center bg-slate-950/40 p-4 modal-overlay fade-in duration-200">
